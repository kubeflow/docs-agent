...
@dsl.component(base_image="python:3.9", packages_to_install=["pymilvus"])
    ...
    try:
        ...
        for file_path in file_paths_list:
            ...
            try:
                ...
                query_result = collection.query(expr=expr, output_fields=["id"], limit=10000)
...
def store_milvus_incremental(
    ...
    if records:
        ...
        print(
            f"✅ Inserted {len(records)} new records. Total collection size: {collection.num_entities}"
        )
    else:
